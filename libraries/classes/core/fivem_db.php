...
class fivem_db{
	...
	public function __construct(){
		...
		try {
			...
			$this->_HOST 		=	!empty($this->CONFIG->get("fivem/host")) 		? $this->CONFIG->get("fivem/host") 		: null;
			$this->_DBNAME 		=	!empty($this->CONFIG->get("fivem/dbName"))		? $this->CONFIG->get("fivem/dbName") 	: null;
			...
			$this->file = DIRNAME(DIRNAME(DIRNAME(__FILE__))).DS."logfiles".DS."fivem_database.log";
